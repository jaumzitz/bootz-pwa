...
export function Home() {
     ...
     const { data: trailsForYou, isLoading: loadingForYou } = useFetchTrails({range: {min: 0, max: 2}});
     const { data: trailsTrendingNearby = [], loading: loadingTrending } = useFetchTrails({range: {min: 3, max: 5}});
