...
export function Home() {
    ...
    const { trails: trailsForYou, loading: loadingForYou } = useFetchTrails({range: {min: 0, max: 2}});
    const { trails: trailsTrendingNearby, loading: loadingTrending } = useFetchTrails({range: {min: 3, max: 5}});

    console.log(trailsForYou)
